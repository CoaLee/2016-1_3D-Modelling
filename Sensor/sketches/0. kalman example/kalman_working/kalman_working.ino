...
uint32_t a_2, m_2;
float a_magnitude, m_magnitude;
float ax_normal, ay_normal, az_normal, mx_normal, my_normal, mz_normal;
...
void loop() {
  ...
  cax = ax * 8.0f/32768.0f;
  cay = ay * 8.0f/32768.0f;
  caz = az * 8.0f/32768.0f;
  ...
  if (DebugMonitor){
    ...
    Serial.print("d_ :\t");
    Serial.print(di_x); Serial.print("\t");
    Serial.print(di_y); Serial.print("\t");
    Serial.print(di_z); Serial.print("\t");
