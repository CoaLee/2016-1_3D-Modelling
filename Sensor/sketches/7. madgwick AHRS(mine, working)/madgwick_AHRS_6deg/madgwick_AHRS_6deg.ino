...
int16_t cnt;
int32_t sumgx, sumgy, sumgz;
int16_t avggx, avggy, avggz;
...
//  if(changed){
  ...
  oldt = nowt;
    ...
    cgx = gx * 500.0f/32768.0f;
    cgy = gy * 500.0f/32768.0f;
    cgz = gz * 500.0f/32768.0f;
    cmx = mx * 10.0f * 1229.0f/4096.0f + 18.0f;
    cmy = my * 10.0f * 1229.0f/4096.0f + 70.0f;
    cmz = mz * 10.0f * 1229.0f/4096.0f + 270.0f;
    
    MadgwickAHRSupdate(cax, cay, caz, cgx*PI/180.0f, cgy*PI/180.0f, cgz*PI/180.0f, my, mx, -mz);
...
//  }
  ...
  if(DebugMonitor){
    ...
    Serial.print(sumgz); Serial.print("\t");
    Serial.print("avgg:\t"); 
    Serial.print(avggx); Serial.print("\t");
    Serial.print(avggy); Serial.print("\t");
